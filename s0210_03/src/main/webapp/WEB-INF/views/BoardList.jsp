    ...
    <ul>
      <c:choose>
        <c:when test="${empty sessionScope.memberId}">
          <li><a href="/join">회원가입</a></li> <span>|</span>
          <li><a href="/login">로그인</a></li>
        </c:when>
        <c:otherwise>
          <li><a href="/logout">로그아웃</a></li> <span>|</span>
          <li><a href="/mUpdate">회원정보</a></li>
        </c:otherwise>
      </c:choose>
      <span>|</span>
  ...
  <section>
    ...
    <table>
      ...
      <c:forEach var="item" items="${boardList}" varStatus="status">
        <tr>
          <td>${item.no}</td>
          <td class="table-title"><a href="/board/detail?no=${item.no}">${item.title}</a></td>
    ...
    <div class="wrapper">
      ...
      <div class="footer-center">
        <ul class="footer-nav">
          ...
          <li>법적고지</li>
          <li class="first-list">사업자정보 확인</li>
        </ul>
