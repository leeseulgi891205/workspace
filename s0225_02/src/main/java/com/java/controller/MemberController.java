...
public class MemberController {
	...
	public String mupdate(MemberDto mdto, @RequestParam(name = "phone1", required = false) String phone1,
			@RequestParam(name = "phone2", required = false) String phone2,
			@RequestParam(name = "phone3", required = false) String phone3, Model model) {
		String id = (String) session.getAttribute("sessionId");
		mdto.setId(id);
		String phone = String.format("%s-%s-%s", phone1, phone2, phone3);
		mdto.setPhone(phone);
		System.out.println("controller : " + mdto.getGender());
		// db저장 - update
	...
	public String memberShip(MemberDto mdto, @RequestParam(name = "phone1", required = false) String phone1,
			@RequestParam(name = "phone2", required = false) String phone2,
			@RequestParam(name = "phone3", required = false) String phone3, Model model) {
		String phone = String.format("%s-%s-%s", phone1, phone2, phone3);
	...
	public String login(MemberDto mdto) {
		System.out.println("controller : " + mdto.getId() + ", " + mdto.getPw());
