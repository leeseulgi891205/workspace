      ...
      <div class="form-box">
        <table>
          <tr>
            ...
            <td>
              <div class="id-check-box">
                <input type="text" name="userId" placeholder="영문소문자/숫자, 4~16자">
          ...
          <tr>
            ...
            <td><input type="password" name="userPwd" placeholder="영문 대소문자/숫자/특수문자 중 2가지 이상 조합, 10자~16자"></td>
          </tr>
          <tr>
            <td>비밀번호 확인 <span style="color:red"></span></td>
            <td><input type="password" name="userPwdConfirm"></td>
          </tr>
          <tr>
            <td>이름</td>
          ...
          <tr>
            ...
            <td><input type="text" name="userNickname" placeholder="사용할 닉네임 입력"></td>
          </tr>
          <tr>
            <td>휴대전화 <span style="color:red"></span></td>
            <td>
              <div class="phone-input">
                <select name="userPhonePrefix">
                  <option>010</option>
                  <option>011</option>
                  <option>016</option>
                  <option>017</option>
                ...
                <span>-</span>
                <input type="text" name="userPhoneMiddle" maxlength="4">
                <span>-</span>
                <input type="text" name="userPhoneLast" maxlength="4">
              </div>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <div class="email-input">
                <input type="email" name="userEmail" placeholder="example@domain.com">
