...
<body>
  ...
  <div class="write-container">
    ...
    <form action="./doBoardWrite.do" name="frm" method="post" class="write-form" id="writeForm">
      <input type="text" name="id" id="id" placeholder="작성자" maxlength="20" required />
      <input type="text" name="btitle" id="btitle" placeholder="제목" maxlength="100" required />
  ...
  <script>
    ...
    writeForm.addEventListener('submit', (e) => {
      const writer = document.getElementById('id').value.trim();
