				...
				<fieldset class="fieldset_class">
					...
					<dl id="modify_address_dl">
						...
						<dd>
							...
							<input type="text" id="address1" name="address1" value="?쒖슱??湲덉쿇援?媛?곕뵒吏??濡?186." required />
							<input type="text" id="address2" name="address2" value="(媛?곕룞. ?쒖씠?뚮씪痢?5F. 515,516??" required />
						</dd>
					...
					<dl id="modify_job_dl">
						...
						<dd>
							<select id="job" name="job">
								...
								<option selected value="student">?숈깮</option>
