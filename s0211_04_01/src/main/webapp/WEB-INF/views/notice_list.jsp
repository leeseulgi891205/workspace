  ...
  <section>
    ...
    <div class="wrapper">
      <form action="/search" name="search" method="post">
        <select name="category" id="category">
          ...
          <option value="title">?쒕ぉ</option>
          <option value="content">?댁슜</option>
        </select>
    ...
    <table>
      ...
      <tr>
        ...
        <td class="table-title">?좎쥌肄붾줈?섎컮?대윭???덈갑愿???댁쁺 ?덈궡</td>
        <td>2020-02-28</td>
      </tr>
      <tr>
        <td><span class="table-notice">NOTICE</span></td>
        <td class="table-title">[2020???? ?쒖꽕 ?뺣퉬 怨듭궗 ?덈궡</td>
        <td>2020-02-28</td>
      </tr>
      <tr>
        <td><span class="table-notice">NOTICE</span></td>
        <td class="table-title">[?ㅼ쫰?? 2020???댁슜 ?쒓컙 & ?댁슜 ?붽툑 蹂寃??덈궡</td>
        <td>2019-12-11</td>
      </tr>
      <tr>
        <td><span class="table-notice">NOTICE</span></td>
        <td class="table-title">[?ㅼ쫰?? 2020??1遺꾧린 ?뺢린 ?닿????덈궡</td>
        <td>2019-12-11</td>
      </tr>
      <tr>
        <td><span class="table-notice">NOTICE</span></td>
        <td class="table-title">?덊럹?댁? 媛쒖씤?뺣낫 蹂댁븞 媛뺥솕</td>
        <td>2018-11-14</td>
      </tr>
      <tr>
        <td>5</td>
        <td class="table-title">[?ㅼ쫰?? 3???꾨줈洹몃옩 ?덈궡</td>
        <td>2020-02-18</td>
      </tr>
      <tr>
        <td>4</td>
        <td class="table-title">[?ㅼ쫰?? 2???꾨줈洹몃옩 ?덈궡</td>
        <td>2020-01-17</td>
      </tr>
      <tr>
        <td>3</td>
        <td class="table-title">留덉씠?ㅼ뒪 硫ㅻ쾭???덈궡</td>
        <td>2019-05-08</td>
      </tr>
      <tr>
        <td>2</td>
        <td class="table-title">[留덉씠?ㅼ뒪 ?명뀛&由ъ“?? ??3??寃쎄린嫄댁텞臾명솕 湲덉긽 ?섏긽</td>
        <td>2018-10-10</td>
      </tr>
      <tr>
        <td>1</td>
        <td class="table-title">移댁뭅?ㅽ뵆?ъ뒪 移쒓뎄 ?ㅽ뵂</td>
        <td>2018-07-11</td>
      </tr>
    </table>
