...
//	@PutMapping("/board/bdelete") // 게시글삭제 Method전송방식
	...
	public String bview(BoardDto boardDto, @RequestParam(name = "flag", required = false) String flag, Model model) {
	...
	// 검색 ----------------------------------
	@GetMapping("/board/bsearch") // 검색하기
	public String bsearch(searchDto searchDto,
			@RequestParam(name = "page", required = false, defaultValue = "1") int page, Model model) {
		searchDto.setPage(page);
		System.out.println("검색어 : " + searchDto.getSearchType() + "," + searchDto.getSearchWord());
	...
	public String blist(@RequestParam(name = "flag", required = false) String flag,
