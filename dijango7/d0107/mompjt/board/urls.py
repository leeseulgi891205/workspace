...
urlpatterns = [
    ...
    path('free/<int:post_id>/comment/create/', views.free_comment_create, name='free_comment_create'),
    path('free/comment/<int:comment_id>/update/', views.free_comment_update, name='free_comment_update'),
    path('free/comment/<int:comment_id>/delete/', views.free_comment_delete, name='free_comment_delete'),
    
    # ▼▼▼ [빠른 한 줄 글쓰기] 26-01-07 추가 - 메인페이지 즉시 참여 ▼▼▼
    path('quick-post/create/', views.quick_post_create, name='quick_post_create'),
    ...
    path('flea/<int:pk>/report/', views.flea_report_create, name='flea_report_create'),
