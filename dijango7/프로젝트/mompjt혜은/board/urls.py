...
urlpatterns = [
    ...
    # ▼▼▼ [상태체크] 26-01-08 혜은 ▼▼▼
    path("mindcheck/", views.mindcheck_page, name="mindcheck"),  # 상태체크 페이지
    path("mindcheck/submit/", views.mindcheck_submit, name="mindcheck_submit"),  # 상태체크 제출 처리
    path("mindcheck/result/", views.mindcheck_result, name="mindcheck_result"),  # 상태체크 결과 페이지
